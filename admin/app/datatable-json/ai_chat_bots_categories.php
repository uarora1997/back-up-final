...
$sql = "SELECT * FROM `" . $config['db']['pre'] . "ai_chat_bots_categories`";
...
foreach ($queryRecords as $row) {
    ...
    $rows[] = '<td class="text-center">
                <div class="btn-group">
                <a href="#" title="' . __('Edit') . '" data-url="panel/ai_chat_bots_categories.php?id=' . $id . '" data-toggle="slidePanel"  class="btn-icon mr-1" data-tippy-placement="top"><i class="icon-feather-edit"></i></a>
                </div>
            </td>';
    $rows[] = '<td>
                <div class="checkbox">
