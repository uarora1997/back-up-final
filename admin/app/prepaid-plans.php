...
<?php include '../sidebar.php'; ?>
            ...
            <div class="quick-card card">
                <div class="card-body">
                    <div class="dataTables_wrapper">
                        <table class="table table-striped" id="ajax_datatable" data-jsonfile="prepaid_plan.php" data-reorder-action="prepaidPlansPosition" data-order-dir="asc">
                            <thead>
                            <tr>
                                <th width="20"></th>
    ...
    <div class="site-action">
        ...
        <button type="button" class="front-icon btn btn-primary btn-floating"
                data-url="panel/prepaid_plan_add.php" data-toggle="slidePanel">
    ...
    <script>
        var QuickMenu = {"page": "prepaid-plans"};
    </script>
