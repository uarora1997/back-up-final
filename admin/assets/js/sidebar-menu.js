(function ($) {
    ...
    if($(".iconMenu-bar li[data-page='"+page+"']").parents("ul").data("id")=="open-icon-menu") {
        $('.iconsidebar-menu').removeClass('iconbar-mainmenu-close');
    ...
    if($(".iconMenu-bar li[data-page='"+page+"']").parent("ul").parent("li").data("id")=="open-listing-menu"){
        $(".iconMenu-bar li[data-page='"+page+"']").parent("ul").parent("li").addClass("open");
    }
