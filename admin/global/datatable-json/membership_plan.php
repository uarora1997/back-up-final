...
foreach ($queryRecords as $row) {
    ...
    $row2 = '<td>'.price_format($monthly_price).'</td>';
    $row3 = '<td>'.price_format($annual_price).'</td>';
    $row4 = '<td>'.price_format($lifetime_price).'</td>';
