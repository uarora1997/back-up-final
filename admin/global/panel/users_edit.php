        ...
        <form method="post" data-ajax-action="addEditUser" id="sidePanel_form">
            <div class="form-body">
                ...
                <div class="form-group">
                    <div class="row">
                        <div class="col-md-2">
                            <img src="<?php _esc(SITEURL . '/storage/profile/' . $fetchuserpic); ?>" width="80"
                                 class="rounded" alt="">
                        </div>
                        <div class="col-md-10">
                ...
                <div class="form-group">
                    ...
                    <input id="id_fullname" type="text" class="form-control" name="name"
                           value="<?php _esc($fetchuser['name']); ?>">
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                    ...
                    <select class="form-control" name="sex">
                        <option value="Male" <?php if ($fetchuser['sex'] == "Male") {
                            echo "selected";
                        } ?>><?php _e("Male"); ?></option>
                        <option value="Female" <?php if ($fetchuser['sex'] == "Female") {
                            echo "selected";
                ...
                <div class="form-group">
                    ...
                    <textarea name="about" rows="6" class="form-control tiny-editor"
                              id="pageContent"><?php _esc($fetchuser['description']); ?></textarea>
                </div>
                ...
                <div class="form-group plan_expiration_date">
                    ...
                    <input id="id_exdate" type="date" class="form-control" name="plan_expiration_date"
                           value="<?php _esc($default_expiration); ?>">
                </div>
                <h5 class="text-primary m-t-35"><?php _e("User's Data"); ?>
                    <small><?php _e('(Excluding the membership data)') ?></small></h5>
                <hr>
                <div class="form-group">
                    <label for="total_words_available"><?php _e("AI Words"); ?></label>
                    <input id="total_words_available" type="text" class="form-control" name="total_words_available"
                           value="<?php _esc(get_user_option($_GET['id'], 'total_words_available', 0)); ?>">
                </div>
                <div class="form-group">
                    <label for="total_images_available"><?php _e("AI Images"); ?></label>
                    <input id="total_images_available" type="text" class="form-control" name="total_images_available"
                           value="<?php _esc(get_user_option($_GET['id'], 'total_images_available', 0)); ?>">
                </div>
                <div class="form-group">
                    <label for="total_speech_available"><?php _e("Speech to Text"); ?></label>
                    <input id="total_speech_available" type="text" class="form-control" name="total_speech_available"
                           value="<?php _esc(get_user_option($_GET['id'], 'total_speech_available', 0)); ?>">
                </div>
                <div class="form-group">
                    <label for="total_text_to_speech_available"><?php _e("Text to Speech Characters"); ?></label>
                    <input id="total_text_to_speech_available" type="text" class="form-control"
                           name="total_text_to_speech_available"
                           value="<?php _esc(get_user_option($_GET['id'], 'total_text_to_speech_available', 0)); ?>">
                </div>
                <h5 class="text-primary m-t-35"><?php _e("Account Setting"); ?></h5>
                <hr>
                <div class="form-group">
                    <label for="id_uname"><?php _e("Username"); ?></label>
                    <input id="id_uname" type="text" class="form-control" name="username"
                           value="<?php _esc($fetchuser['username']); ?>">
                </div>
                <div class="form-group">
                    <label for="id_email"><?php _e("Email address"); ?></label>
                    <input id="id_email" type="email" class="form-control" name="email"
                           value="<?php _esc($fetchuser['email']); ?>">
                </div>
                <div class="form-group">
                    <label for="id_pw2"><?php _e("New Password"); ?></label>
                    <input id="id_pw2" type="password" class="form-control" placeholder="<?php _e("New Password"); ?>"
                           name="password">
                </div>
