...
<div class="iconsidebar-menu iconbar-mainmenu-close">
    <div class="sidebar">
        <ul class="iconMenu-bar custom-scrollbar">
            ...
            <li class="open" data-page="ai-templates" data-id="open-listing-menu">
                <a class="bar-icons" href="javascript:void(0)">
                    <i class="icon-feather-image"></i><span><?php _e('Product Settings') ?></span>
                </a>
                <ul class="iconbar-mainmenu custom-scrollbar nav" data-id="open-icon-menu">
                    <li class="iconbar-header"><?php _e('Product Settings') ?></li>

                    <li data-page="ai-templates">
                        <a href="<?php echo ADMINURL; ?>app/ai-templates.php"><?php _e('All AI Tools') ?></a>
                    </li>
                    <!-- <li><a class="dropdown-item" href="#">Action</a></li> -->
                    <li data-page="ai-templates">
                        <ul class="open">
                            <li><a href="<?php echo ADMINURL; ?>app/ai-templates.php" data-page="ai-templates">
                                    <?php _e('AI Templates') ?>
                                </a></li>
                            <li><a href="<?php echo ADMINURL; ?>app/ai-custom-templates.php" data-page="ai-custom-templates">
                                    <?php _e('Custom Templates') ?>
                                </a></li>
                            <li><a href="<?php echo ADMINURL; ?>app/ai-template-categories.php" data-page="ai-template-categories">
                                    <?php _e('Categories') ?>
                                </a></li>
                        </ul>
                    </li>
                    ...
                    <li data-page="ai-images">
                        <a href="<?php echo ADMINURL; ?>app/ai-images.php" data-page="ai-images"><?php _e('AI Images') ?></a>
                    </li>

                    <li data-page="ai-chat-bots">
                        <a href="<?php echo ADMINURL; ?>app/ai-chat-bots.php"><?php _e('AI Chat Bots') ?></a>
                    </li>

                    <li data-page="ai-chat-bots">
                        <ul class="open">
                            <li><a href="<?php echo ADMINURL; ?>app/ai-chat-bots.php" data-page="ai-chat-bots">
                                    <?php _e('AI Chat Bots') ?>
                                </a></li>
                            <li><a href="<?php echo ADMINURL; ?>app/ai-chat-bots-categories.php" data-page="ai-chat-bots-categories">
                                    <?php _e('Categories') ?>
                                </a></li>
                        </ul>
                    </li>
                    ...
                    <li data-page="email-template">
                        <a href="<?php echo ADMINURL; ?>global/email-template.php" data-page="email-template">
                            <span>
                                <?php _e('Email Notifications') ?>
                            </span>
                        </a>
                    </li>
                    <li data-page="api-keys">
                        <a href="<?php echo ADMINURL; ?>app/api-keys.php" data-page="api-keys">
                            <span>
                                <?php _e('API Keys') ?>
                            </span>
                        </a>
            ...
            <li class="open" data-page="ai-documents" data-id="open-listing-menu">
                <a class="bar-icons" href="javascript:void(0)">
                    <i class="icon-feather-file"></i><span><?php _e('Product Analytics') ?></span>
                </a>
                <ul class="iconbar-mainmenu custom-scrollbar nav" data-id="open-icon-menu">
                    <li class="iconbar-header"><?php _e('Product Analytics') ?></li>

                    <li data-page="ai-documents">
                        <a href="<?php echo ADMINURL; ?>app/ai-documents.php" data-page="ai-documents">
                            <span><?php _e('AI Created Documents') ?></span>
                        </a>
                    </li>
                    <li data-page="transactions">
                        <a href="<?php echo ADMINURL; ?>global/transactions.php" data-page="transactions">
                            <span><?php _e('Customer Transactions') ?></span>
                        </a>
                    </li>
                </ul>
            </li>
            <li class="open" data-page="membership" data-id="open-listing-menu">
                <a class="bar-icons" href="javascript:void(0)">
                    <i class="icon-feather-gift"></i><span>
                        <?php _e('Plan Settings') ?>
                    </span>
                </a>
                <ul class="iconbar-mainmenu custom-scrollbar nav" data-id="open-icon-menu">
                    ...
                    <li data-page="membership">
                        <a href="<?php echo ADMINURL; ?>global/membership_plan.php">
                            <?php _e('Membership Subsciption Plan') ?>
                        </a>
                    </li>
                    <!-- <li><a class="dropdown-item" href="#">Action</a></li> -->
                    <li data-page="membership">
                        <ul class="open">
                            <li><a href="<?php echo ADMINURL; ?>global/membership_plan.php" data-page="membership-plans">
                                    <?php _e('Plans') ?>
                                </a></li>
                            <li><a href="<?php echo ADMINURL; ?>global/membership_plan_custom.php" data-page="membership-custom">
                                    <?php _e('Custom Settings') ?>
                                </a></li>
                            <li><a href="<?php echo ADMINURL; ?>global/upgrades.php" data-page="membership-upgrades">
                                    <?php _e('Upgrades') ?>
                                </a></li>
                            <li><a href="<?php echo ADMINURL; ?>global/cron_logs.php" data-page="cron-logs">
                                    <?php _e('Cron Logs') ?>
                                </a></li>
                            <li><a href="<?php echo ADMINURL; ?>global/taxes.php" data-page="taxes">
                                    <?php _e('Taxes') ?>
                                </a></li>
                        </ul>
                    </li>
                    ...
                    <li data-page="prepaid-plans">
                        <a href="<?php echo ADMINURL; ?>app/prepaid-plans.php" data-page="prepaid-plans">
                            <span>
                                <?php _e('Pay as you go') ?>
                            </span>
                        </a>
                    </li>
                    <li data-page="payment-methods">
                        <a href="<?php echo ADMINURL; ?>global/payment_methods.php" data-page="payment-methods">
                            <span>
                    ...
                    <li data-page="taxes">
                        <a href="<?php echo ADMINURL; ?>global/taxes.php" data-page="taxes">
                            <span>
                                <?php _e('Taxes') ?>
                            </span>
                        </a>
            ...
            <li class="open" data-page="testimonials" data-id="open-listing-menu">
                <a class="bar-icons" href="javascript:void(0)">
                ...
                <ul class="iconbar-mainmenu custom-scrollbar nav" data-id="open-icon-menu">
                    ...
                    <li data-page="testimonials">
                        <a href="<?php echo ADMINURL; ?>global/testimonials.php" data-page="testimonials">
                            <span><?php _e('Testimonials') ?></span>
                        </a>
                    </li>
                    <li data-page="faq_entries">
                        <a href="<?php echo ADMINURL; ?>global/faq_entries.php" data-page="faq_entries">
                            <span><?php _e('FAQ') ?></span>
                        </a>
                    </li>
                    <li data-page="pages">
                        <a href="<?php echo ADMINURL; ?>global/pages.php" data-page="pages">
                            <span><?php _e('Pages') ?></span>
                        </a>
                    </li>

                    <li data-page="blog">
                        <a href="<?php echo ADMINURL; ?>global/blog.php">
                            <?php _e('Blog') ?>
                        </a>
                    </li>
                    <li data-page="blog">
        ...
        <li class="open" data-page="users" data-id="open-listing-menu">
            <a class="bar-icons" href="javascript:void(0)">
                <i class="icon-feather-users"></i><span>
                    <?php _e('User Management') ?>
                </span>
            </a>
            <ul class="iconbar-mainmenu custom-scrollbar nav" data-id="open-icon-menu">
                <li class="iconbar-header">
                ...
                <li data-page="users">
                    <a href="<?php echo ADMINURL; ?>global/users.php" data-page="users">
                        <span><?php _e('Users') ?></span>
                    </a>
                </li>
                <li data-page="admins">
                    <a href="<?php echo ADMINURL; ?>global/admins.php" data-page="admins">
                        <span><?php _e('Admins') ?></span>
                    </a>
                </li>
                <li data-page="subscriber">
                    <a href="<?php echo ADMINURL; ?>global/subscriber.php" data-page="subscriber">
                        <span><?php _e('Subscribers') ?></span>
                    </a>
                </li>
            </ul>
        </li>
        <!-- <li data-page="ai-templates">
            ...
            <li data-page="ai-chat-prompts">
                <a class="bar-icons" href="<?php echo ADMINURL; ?>app/ai-chat-prompts.php">
                    <i class="icon-feather-align-center"></i><span><?php _e('Chatbots Prompt Library') ?></span>
                </a>
            </li>
            <!-- <li data-page="membership">
            ...
            <li data-page="settings">
                ...
                <ul class="iconbar-mainmenu custom-scrollbar nav">
                    ...
                    <li>
                        <a href="#quick_international" data-toggle="tab"><?php _e('Geo Settings') ?></a>
                    </li>
                    <li>
