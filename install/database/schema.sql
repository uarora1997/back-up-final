...
(
    ...
    `balance_last_update` DATETIME     NULL     DEFAULT NULL,
    `active`              tinyint(1)   NOT NULL DEFAULT 1,
    PRIMARY KEY (`id`)
) ENGINE = InnoDB
  DEFAULT CHARSET = utf8mb4
...
--
-- Table structure for table `<<prefix>>ai_chat_bots`
--
...
--
-- Table structure for table `<<prefix>>ai_chat_conversations`
--

DROP TABLE IF EXISTS `<<prefix>>ai_chat_conversations`;
CREATE TABLE `<<prefix>>ai_chat_conversations`
(
    `id`           int(11) NOT NULL AUTO_INCREMENT,
    `title`        varchar(255) DEFAULT NULL,
    `user_id`      int(11)      DEFAULT NULL,
...
--
-- Table structure for table `<<prefix>>ai_chat_prompts`
--

DROP TABLE IF EXISTS `<<prefix>>ai_chat_prompts`;
CREATE TABLE `<<prefix>>ai_chat_prompts`
(
    `id`          int(11)    NOT NULL AUTO_INCREMENT,
    `title`       varchar(255)        DEFAULT NULL,
...
--
-- Table structure for table `<<prefix>>ai_speeches`
--

DROP TABLE IF EXISTS `<<prefix>>ai_speeches`;
CREATE TABLE `<<prefix>>ai_speeches`
(
    `id`         int(11) NOT NULL AUTO_INCREMENT,
    `user_id`    int(11)      DEFAULT NULL,
    `title`      varchar(255) DEFAULT NULL,
...
--
-- Table structure for table `<<prefix>>text_to_speech_used`
--

DROP TABLE IF EXISTS `<<prefix>>text_to_speech_used`;
CREATE TABLE `<<prefix>>text_to_speech_used`
(
    `id`         int(11) NOT NULL AUTO_INCREMENT,
    `user_id`    int(11)  DEFAULT NULL,
...
--
-- Table structure for table `<<prefix>>ai_chat_bots_categories`
--

DROP TABLE IF EXISTS `<<prefix>>ai_chat_bots_categories`;
CREATE TABLE `<<prefix>>ai_chat_bots_categories`
(
    `id`               int(11)    NOT NULL AUTO_INCREMENT,
    `title`            varchar(255)        DEFAULT NULL,
    `translation_lang` longtext            DEFAULT NULL,
...
--
-- Table structure for table `<<prefix>>prepaid_plans`
--

DROP TABLE IF EXISTS `<<prefix>>prepaid_plans`;
CREATE TABLE `<<prefix>>prepaid_plans`
(
    `id`          int(11)           NOT NULL AUTO_INCREMENT,
    `name`        varchar(255)               DEFAULT NULL,
