...
if(isset($current_user['id'])) {
    ...
    foreach ($rows as $row)
    {
        ...
        } else if($row['transaction_method'] == 'prepaid_plan'){
            $premium = '<span class="dashboard-status-button green">'.__("Prepaid Plan").'</span>';
        }
        ...
        if ($t_status == "success") {
            ...
            $status = '<span class="dashboard-status-button red">'.__("Cancel").'</span>';
        }
