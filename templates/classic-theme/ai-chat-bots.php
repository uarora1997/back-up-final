                    ...
                    <ul>
                        ...
                        foreach ($chat_bots as $category) { ?>
                            <li><a href="javascript:void();" class="ai-templates-category"
                                   data-category="<?php _esc($category['id']) ?>"><?php _esc($category['title']) ?></a>
                            </li>
                        <?php }
                        ?>
                    </ul>
                ...
                <div class="row ai-template-blocks">
                    ...
                    <?php foreach ($chat_bots as $category) {
                        foreach ($category['chat_bots'] as $chat_bot) {
                            ...
                            ?>
                            <div class="col-lg-3 col-md-4 col-sm-6 category-<?php _esc($category['id']) ?>" data-search="<?php _esc($chat_bot['name'] . ' '. $chat_bot['role'] . ' ' . $category['title']) ?>">
