                ...
                <div class="popup-tab-content">
                    ...
                    <div id="chat-prompts-list">
                        <?php foreach ($chat_prompts as $chat_prompt) { ?>
                            <a href="javascript:void(0)"
                               data-search-key="<?php _esc(escape($chat_prompt['prompt'] . ' ' . $chat_prompt['description'])) ?>"
                               data-prompt="<?php _esc(escape($chat_prompt['prompt'])) ?>">
                                <div class="dashboard-box ai-templates">
                                    <div class="content">
                                        <h4>
                                            <?php _esc($chat_prompt['title']) ?>
                                        </h4>
                                        <p class="margin-bottom-0"><?php _esc($chat_prompt['description']) ?></p>
                                    </div>
                                </div>
                            </a>
                        <?php } ?>
...
<?php } ?>
    ...
    <script>
        ...
        const ENABLE_TYPING_EFFECT = <?php _esc(get_option("enable_chat_typing_effect",1)); ?>;
