                            ...
                            <?php foreach ($documents as $document) { ?>
                                <tr>
                                    ...
                                    <td data-label="<?php _e("Action") ?>">
                                        <button onclick="window.location.href='<?php echo url('ALL_DOCUMENTS', 0).'/'.$document['id'] ?>'" class="button ripple-effect btn-sm"
                                                data-tippy-placement="top"
                                                title="<?php _e("Show Document") ?>"><i class="fa fa-eye"></i>
                                        </button>
                                        <button class="button red ripple-effect btn-sm quick-delete"
                                                data-id="<?php _esc($document['id']) ?>"
