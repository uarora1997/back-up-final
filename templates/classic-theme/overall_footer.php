            ...
            <div class="row">
                <div class="col-xl-5 col-lg-5 col-md-12">
                    <div class="footer-logo">
                        <img src="<?php _esc($config['site_url']); ?>storage/logo/<?php _esc($config['site_logo_footer']); ?>"
                             alt="Footer Logo">
                    </div>
                        ...
                        <div class="d-flex gap-2">
                            <?php if (!empty(get_option("android_app_link"))) { ?>
                                <a href="<?php _esc(get_option("android_app_link")) ?>" target="_blank" rel="nofollow">
                                    <img src="<?php _esc(TEMPLATE_URL); ?>/images/google-play.png" height="40"
                                         alt="google-play">
                                </a>
                            <?php }
                            if (!empty(get_option("ios_app_link"))) {
                                ?>
                                <a href="<?php _esc(get_option("android_app_link")) ?>" target="_blank" rel="nofollow">
                                    <img src="<?php _esc(TEMPLATE_URL); ?>/images/app-store.png" height="40"
                                         alt="app-store">
                                </a>
                            <?php } ?>
                        </div>
    ...
    <div id="sign-in-dialog" class="zoom-anim-dialog mfp-hide dialog-with-tabs popup-dialog">
        ...
        <div class="popup-tabs-container">
            <div class="popup-tab-content" id="login">
                ...
                <?php
                $demo_uname = $demo_pass = '';

                if (!check_allow()) {
                    $demo_uname = $demo_pass = 'demo';
                }
                ?>
                <form id="login-form" method="post"
                      action="<?php _esc($config['site_url']) ?>login?ref=<?php _esc($ref_url) ?>">
                    <div id="login-status" class="notification error" style="display:none"></div>
                    <div class="input-with-icon-left">
                        <i class="la la-user"></i>
                        <input type="text" class="input-text with-border" name="username" id="username"
                               placeholder="<?php _e("Username") ?> / <?php _e("Email Address") ?>"
                               value="<?php _esc($demo_uname) ?>" required/>
                    </div>

                    <div class="input-with-icon-left">
                        <i class="la la-unlock"></i>
                        <input type="password" class="input-text with-border" name="password" id="password"
                               placeholder="<?php _e("Password") ?>" value="<?php _esc($demo_pass) ?>" required/>
                    </div>
                    ...
                    <button id="login-button" class="button full-width button-sliding-icon ripple-effect" type="submit"
                            name="submit"><?php _e("Login") ?> <i class="icon-feather-arrow-right"></i></button>
                </form>
            </div>
        </div>
    </div>
